...
export function SettingsView() {
  ...
  return <>
    <section className="page-header"><div><p className="eyebrow">SISTEMA / CONTROLE</p><h1>Ajuste o painel<br /><em>ao seu jeito.</em></h1><p className="page-header__description">Cadastre sua moto, organize dados de consumo e mantenha seus lembretes documentais à vista.</p></div></section>
