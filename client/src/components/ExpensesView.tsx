...
export function ExpensesView() {
  ...
  const saveExpense = () => {
    try {
      ...
      setExpenses((current) => [{ category: expense.category, label: expense.description, meta: `Hoje${litersMeta}`, value: expense.formattedAmount, amount: expense.amount, tone }, ...current]);
